...
request_query = 'https://api.nusmods.com/v2/2021-2022/semesters/1/venueInformation.json'
...
request_query = 'https://api.nusmods.com/v2/2021-2022/semesters/2/venueInformation.json'
r = http.request('GET',request_query)
...
request_query = 'https://api.nusmods.com/v2/2021-2022/semesters/3/venueInformation.json'
r = http.request('GET',request_query)
...
request_query = 'https://api.nusmods.com/v2/2021-2022/semesters/4/venueInformation.json'
r = http.request('GET',request_query)
